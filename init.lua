	...
	cosmetics = {
		...
		entity_cosmetics = {
			santa_hat = {
				...
				-- ~Violet
				["2025"] = {"server_cosmetics_santa_hat.png^(server_cosmetics_santa_hat_overlay.png^[multiply:#cc0072)"},
			},
			hallows_hat = {
				_prefix = S("Wear") .. " ",
				...
				-- ~Kind of ghost-y
				["2025"] = {"server_cosmetics_hallows_hat.png^(server_cosmetics_hallows_hat_overlay.png^[multiply:cyan)"},
			},
			crown = {
				_prefix = S("Wear") .. " ",
